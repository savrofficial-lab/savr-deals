...
export default function App() {
  ...
  // fetch categories once (unique categories from published deals)
  useEffect(() => {
    let mounted = true;
    (async () => {
      try {
            ...
            <div className="max-w-5xl mx-auto px-3 py-2">
              <div className="flex items-center gap-3 overflow-auto">
                ...
                <div ref={categoriesRef} className="relative">
                  ...
                  {showCategories && (
                    <div className="absolute left-0 mt-2 w-56 bg-white shadow-xl rounded-xl p-2 z-50 border">
                      <button
                        onClick={() => {
                          setSelectedCategory("");
                          setShowCategories(false);
                        ...
                        .map((cat) => (
                          <button
                            ...
                            onClick={() => {
                              ...
                              setShowCategories(false);
                              // also clear search since we're using category
                              setSearchRaw("");
                            }}
                            className="block w-full text-left px-3 py-2 rounded hover:bg-gray-100 text-sm"
                          >
